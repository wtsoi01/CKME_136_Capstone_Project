...
############################################################################
#                                                                          #
#                   Author: Weiai Wayne Xu                                 #
#                   Adapted by: William Tsoi to collect Tweet Data on      #
#                   TSLA and TESLA                                         #
...
ids = ['%23TSLA',
       '%23TESLA',] # enter your search terms
       
from twython import Twython
t = Twython(app_key='NhXRAUVfxXXXXXXIrMdw4gWnX',       #REPLACE 'APP_KEY' WITH YOUR APP KEY, ETC., IN THE NEXT 4 LINES
    app_secret='jLyg1uGIQvOu1AXrchDeXXXXXXMLOhzp1CFLVWNLQ8D16LCiiF',
    oauth_token='2891822912-7ED9AQ6nXXXXXXXXLvjoyI9A1NVPDgS5FOxwOnh',
    oauth_token_secret='2Y13lDeArXAH9cAwZXXXXXXXX0x6XuRTdazxb9L3ZgRKw')
...
def get_data(kid, max_id=None):
    try:
        d = t.search(q=kid, count = '200', result_type = 'recent', lang = 'en', max_id = max_id) # lang = 'en'
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///d:/test/tsla24Mar.sqlite", echo=False)  
